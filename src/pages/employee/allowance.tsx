  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-2xl font-bold tracking-tight text-foreground">Data Tunjangan & Bonus Saya</h2>
          <p className="text-muted-foreground text-sm">
            Daftar tunjangan dan bonus kinerja yang Anda terima.
          </p>
        </div>
      </div>
      ...
      <div className="w-full">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-stretch lg:items-center gap-3 mt-4 mb-4">
          <div className="relative w-full lg:w-80">
            ...
            <Input
              placeholder="Cari tunjangan atau bonus..."
              value={searchQuery}
