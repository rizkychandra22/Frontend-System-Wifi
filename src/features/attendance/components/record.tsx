      ...
      <Card className="border-red-500 bg-red-50">
        <CardContent className="pt-6 flex flex-col items-center text-center">
          ...
          <p className="text-foreground">
            Tidak ada aktivitas absensi untuk hari ini karena tidak ada karyawan yang absen masuk hingga jam 12:00.
          </p>
        </CardContent>
      </Card>
    );
    ...
    <div className="grid gap-6 md:grid-cols-2">
      ...
      <Card className={record ? "opacity-75" : "border-primary"}>
        <CardHeader>
          ...
          <CardDescription>Batas waktu 12:00 WIB</CardDescription>
        </CardHeader>
